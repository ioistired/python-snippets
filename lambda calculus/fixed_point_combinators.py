...
# R for "recursion"
R = lambda f: lambda *args: f(f)(*args)

_fact = lambda f: lambda x: 1 if x == 0 else x * f(f)(x - 1)
...
R = lambda f: lambda *args: f(M(f))(*args)
_fact = lambda f: lambda x: 1 if x == 0 else x * f(x - 1)
